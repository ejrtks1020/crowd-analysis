...
class ModelRouter:
    def __init__(self, onnx_file, gender):
    ...
    def get_model(self, **kwargs):
        ...
        if len(outputs)>=5:
            ...
            return ArcFaceONNX(model_file=self.onnx_file, session=session, gender=self.gender)
...
def get_model(name, gender, **kwargs):
    ...
    router = ModelRouter(model_file, gender)
